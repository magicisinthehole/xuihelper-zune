...
namespace XUIHelper.Core.Extensions
{
    internal static class BinaryWriterExtensions
    {
        ...
        #region String
        // Misnamed in upstream: writes UTF-16 BE. Using BinaryWriter.Write(char)
        // applies the writer's encoding (UTF-8 by default), which corrupts any
        // non-ASCII char into 2 UTF-8 bytes after the 0x00 high byte. Use explicit
        // UTF-16 BE bytes instead.
